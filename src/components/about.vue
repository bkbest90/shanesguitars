  ...
  {{changeFoot ('ipad pro')}}
    ...
    <div class="w3-container w3-center w3-animate-top" v-if="fixedTop == false" >
      ...
      <div style="margin-bottom:-10px;margin-top:-15px">
        ...
        <router-link to="/about"><button style="color:black;font-size:27px;padding: 10px 10px" class="buttonL button4">ABOUT</button></router-link>
      </div>
    </div><br>
      <!-- Top Bar Fixed -->
    <div id="bgTop" v-if="fixedTop == true" class="w3-container w3-center w3-animate-top top" style="height:100px;background-size: auto;background-color:white">
      ...
      <div style="margin-top:-75px;margin-left:250px">
        ...
        <router-link to="/about"><button style="color:black;font-size:27px" class="buttonM button4">ABOUT</button></router-link>
      </div>
    </div>
    <h1>ABOUT</h1>
    </div>
...
<div v-if="screenWidth <= 800 && screenWidth >= 350">
  {{changeFoot ('mobile 5.5')}}
      ...
      <div style="text-align:center;padding:7px 0px">
        ...
        <router-link to="/about"><button style="color:black;font-size:16px;width:18%" class="button4 ">ABOUT</button></router-link>
      </div>
      </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div style="margin-top:10px" id="navbarNavDropdown" class="navbar-collapse collapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <router-link to="/about"><button style="background-color:#F8F9FA;font-size:18px;width:25%" class="button4 buttonMobile">ABOUT</button></router-link>
                </li>
            </ul>
        </div>
    </nav>
...
<div v-if="screenWidth < 350">
  {{changeFoot ('iphone5')}}
      ...
      <div style="text-align:center;padding:7px 2px">
        ...
        <router-link to="/about"><button style="color:black;font-size:13px;width:18%" class="button4">ABOUT</button></router-link>
      </div>
      </div>
      <div id="bgTop app" v-if="fixedTop == true" class="w3-container w3-center w3-animate-top top" style="width:111%;margin-left:-17px">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div id="navbarNavDropdown" class="navbar-collapse collapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <router-link to="/about"><button style="background-color:#F8F9FA;font-size:13px;width:17%" class="button4 buttonMobile">ABOUT</button></router-link>
                </li>
            </ul>
        </div>
    </nav>
  ...
  {{changeFoot('desktop')}}
    ...
    <div class="w3-container w3-center w3-animate-top" v-if="fixedTop == false" >
      ...
      <div style="margin-bottom:-10px;margin-top:-15px">
        ...
        <router-link to="/about"><button style="color:black;font-size:20px;padding: 10px 10px" class="buttonL button4">ABOUT</button></router-link>
      </div>
    </div><br>
      <!-- Top Bar Fixed -->
    <div id="bgTop" v-if="fixedTop == true" class="w3-container w3-center w3-animate-top top" style="height:80px;background-size: auto;margin-top:0px;background-color:white">
      ...
      <div style="margin-top:-65px;margin-left:65px">
        ...
        <router-link to="/about"><button style="color:black;font-size:19px" class="buttonM button4">ABOUT</button></router-link>
      </div>
    </div>
    <h1>ABOUT</h1>
</div>
